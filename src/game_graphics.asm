...
draw_left_paddle_up:
    ...
    .nui_speed_loop:
        ...
        mov dx, word[left_paddle_location] ; put temp of left_paddle_location for editing later
        add dx, word[left_paddle_size]          ; get location of bottom of paddle by adding size to temp 
        .nui_1:
            xor bh, bh           ; set page to 0
            int 10h              ; VGA interrupt (write pixel)
            inc cx               ; move x location right one pixel
...
draw_left_paddle_down:
    ...
    sub dx, [left_paddle_size]              ; subtract paddle size to get lower limit for top of paddle
...
draw_left_paddle:
    ...
    .l0:
        ...
        mov bx, word[left_paddle_size]           ; create temp paddle_size
...
draw_right_paddle:
    ...
    .l0:
        ...
        inc dx                              ; move to the next line
        mov bx, word[right_paddle_size]           ; create temp paddle_size
