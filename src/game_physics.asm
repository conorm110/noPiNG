ball_physics:
    .collision:
        ...
        left_wall_collision:
            ...
            mov bl, 0x2                         ; set screen to green
            xor bh, bh
            mov ah, 0xb
            int 10h
            ...
            add dx, [left_paddle_size]          ; add left paddle size to position to get bottom of
                                                ;   paddle position
        ...
        right_wall_collision:
            ...
            add dx, [right_paddle_size]         ; add paddle size to position to get bottom of
                                                ;   paddle position
            add dx, 0x06                        ; allow partial collisions
